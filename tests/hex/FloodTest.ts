...
test('Flood dist<0', () => {
  const t1 = (): void => {
    const x = fill(RectangularHexGrid.generate0(evenVerticalCoords, 5, 5, (c, r) => `(${c},${r})`), OffsetCoord.zero, -1)
    console.log(x)
  }
