...
test('Sparse AStar', () => {
  const grid = new SparseHexGrid(oddHorizontalCoords, new Map([[OffsetCoord.zero, 'a'], [new OffsetCoord(0, 2), 'e'], [new OffsetCoord(1, 0), 'b'], [new OffsetCoord(1, 1), 'c'], [new OffsetCoord(1, 2), 'c'], [new OffsetCoord(1, 3), 'x']]))
